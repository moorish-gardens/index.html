...
$fields = array(
    	array('name' => 'text', 'title' => "<h1>Your garden service consultation request has been received.<br>Thank You</h1> <br> Here is the details"),
